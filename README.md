# ChatbotPy-Project
## ChatBot with interactive UI using simple web socket server and funny. 
...
* Above step will open the server. Now right click the index.html page and open with browser. You will be able to see the chat window where you can start the conversation and test.
